...
**4**|打卡的人|小南最近想看金庸的套书，不知从何看起，所以找了一份金庸的系列小说的顺序清单，他于是去了图书馆，找到了着一本书，在课余时间慢慢借阅这一套图书来观看，《书剑恩仇录》，《碧血剑》......一直到《鹿鼎记》，，看完每一本书，他都会打开软件扫描书本封面，获取了该书的评论信息，进入书本的最后一页，留下评论“2018年11月30号，晚上8点看完，打卡(oﾟvﾟ)ノ”|```pend```| 增加快速添加打卡信息（时间，位置，心情），功能和情绪类颜文字/表情
...
## Attachment
- [软件流程图](https://github.com/treeice/API_ML_AI/blob/master/FLowchart.jpg)
- [开发流程图](https://github.com/treeice/API_ML_AI/blob/master/PRD01_Timeline.png)
- [产品框架图](https://github.com/treeice/API_ML_AI/blob/master/PRD01_Timeline.png)
- [原型图](https://github.com/treeice/API_ML_AI/blob/master/simple-page.jpg)
